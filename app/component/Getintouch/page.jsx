  ...
  return (
    <div className="w-full bg-[#1F1F1F] shadow-md py-16">
      <section className="max-w-[1600px] mx-auto px-4 text-center">
        ...
        <p className=" text-center text-[#f98c2c] font-semibold text-xl leading-relaxed max-w-6xl w-full sm:w-[400px] lg:w-[700px] px-4 mx-auto mb-12">Discover the best assortment of high-quality tobacco products, carefully chosen for enthusiasts who appreciate authenticity, heritage, and workmanship.</p>
