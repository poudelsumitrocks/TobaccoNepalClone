...
export default function Featuredproduct() {
  ...
  return (
    <div className="min-w-full sm:max-h-[1000px] lg:max-h-[1600px]  py-16">
      <section className="flex flex-col  justify-center items-center  px-4 sm:px-8 lg:px-14">
        <h1 className="text-[#EAB308] text-5xl sm:text-6xl font-bold leading-tight mb-6 text-center max-w-3xl">
          Our Featured
          <br className="block sm:hidden" />
          Products
        </h1>

        <p className="text-[#D2863C] text-lg sm:text-lg font-medium leading-relaxed mb-8 text-center max-w-2xl">
        ...
        <div className="mt-8">
          <Link
            href={"/product"}
            className="bg-[#eab308] text-black cursor-pointer hover:bg-amber-300 sm:text-[18px] font-bold text-shadow-2xs ] px-4 py-2 sm:px-6 sm:py-2 rounded-lg shadow-[0_4px_6px_rgba(0,0,0,0.3)] "
          >
            View Products
          </Link>
        </div>
