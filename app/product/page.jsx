 ...
 const selectedProducts = (products || [])
  ...
  return (
    <div className="product-container max-h-full ">
      ...
      <section className="bg-black max-h[1600px] pl-6 pr-6">
        ...
        <div className=" text-center mb-8">
          <h1 className="text-[#D2863C] text-lg font-medium">
            Showing <span className="text-[#EAB308] font-bold ">10</span> of{" "}
            <span className="text-[#EAB308] font-bold">15</span> products
          </h1>
        </div>

        <div className="grid lg:grid-cols-5 md:grid-cols-3 px-2 gap-6 mb-8">
          <button className="flex justify-center items-center bg-[#FEF3C7] h-20 w-56 px-2 py-2 rounded-2xl cursor-pointer text-[#EAB308] font-bold text-lg">
            All Categories
          </button>

          <button className=" items-center justify-center h-20 w-56 px-2 py-2 rounded-lg text-sm lg:text-lg font-semibold transition-all duration-300 cursor-pointer bg-white text-gray-700 hover:-translate-y-1 hover:shadow-lg hover:bg-[#FFF7E6] hover:text-[#EAB308]">
            Guddka Products
          </button>
          <button className=" items-center justify-center h-20 w-56 px-2 py-2 rounded-lg text-sm lg:text-lg font-semibold transition-all duration-300 cursor-pointer bg-white text-gray-700 hover:-translate-y-1 hover:shadow-lg hover:bg-[#FFF7E6] hover:text-[#EAB308]">
          ...
          <button className=" items-center justify-center  flex flex-col h-20 w-56 px-2 py-2 rounded-lg font-bold lg:text-lg transition-all duration-300 cursor-pointer bg-white text-gray-700 hover:-translate-y-1 hover:shadow-lg hover:bg-[#FFF7E6] hover:text-[#EAB308]">
            Sada Pan Masala <span>(Non Tobacco)</span>
          </button>
        </div>
        ...
        <div className="flex justify-center items-center gap-3 ">
          ...
          <div className="w-12 h-12 flex items-center justify-center rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-110 bg-[#EAB308] text-black shadow-lg shadow-[#EAB308]/50 glow-effect">
            {" "}
            1
          </div>
          <div className="w-12 h-12 flex items-center justify-center rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-110 bg-[#2D2D2D] text-white hover:bg-[#3D3D3D] shadow-md">
            {" "}
            2
          </div>
